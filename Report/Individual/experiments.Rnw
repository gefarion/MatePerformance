...
<<perf-overview-mop, fig.width=5, fig.height=2>>=
...
print(
  kable(arrange(summarizedMop, Benchmark), 
       booktabs = T,
       format = "latex",
       longtable = T,
       digits = 2)  %>%
...
\def\MopTableOverall{%
<<perf-mop-table-overall, results="asis">>=
print(
   kable(arrange(overallSummaryMop, Geomean), 
       booktabs = T,
       format = "latex",
       digits = 2,
