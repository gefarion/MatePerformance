...
<<perf-overview-mega, fig.width=4, fig.height=2, fig.align='center', fig.cap='Overhead factor a monomorphic versus a megamorphic IH site.', fig.pos = 'H'>>=
print(boxplot(list(megamorphicNormalized), TRUE, "OF", list(), fill = TRUE))
@
}%
