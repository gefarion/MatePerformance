...
<<perf-overview-tracing, fig.cap='Overhead factors of profiling the amount of method activations in a set of benchmarks.', fig.align='center', out.width = "0.7\\textwidth", fig.pos="H">>=
