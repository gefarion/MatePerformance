...
<<perf-overview-micro, fig.cap='Overhead of MATE normalized to SOM in the context of micro benchmarks', out.width = "0.8\\textwidth", fig.align='center', fig.width=8, fig.height=4>>=
if (CombineMtAndPe) {
  ...
  boxplotMateToSom(list(microPEWithoutRecursive), list('SOMpe'), yTitle = "Overhead Factor", xTitle="Benchmark", title="Mate Overheads to SOM for Non-Reflective Micro Benchmarks")
}
@
}
...
if (CombineMtAndPe) {
  ...
  summaryDataMicro <- microPESummaryWithoutRecursive[,c(2,1,3,4:8)]
}
print(
...
<<perf-overview-macro, fig.cap='Overhead of MATE normalized to SOM in the context of macro benchmarks', out.width = "0.8\\textwidth", fig.align='center', fig.width=8, fig.height=4>>=
if (CombineMtAndPe) {
  ...
  boxplotMateToSom(list(macroPE), list('SOMpe'), yTitle = "Overhead Factor", xTitle="Benchmark", title="Mate Overheads with respect to SOM for Non-Reflective Macro Benchmarks")
}
@
}
...
if (CombineMtAndPe) {
  ...
  summaryDataMacro <- macroPESummary[,c(2,1,3,4:8)]
}
print(
