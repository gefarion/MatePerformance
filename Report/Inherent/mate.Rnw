...
<<perf-overview-micro, fig.cap='Overhead of TruffleMate normalized to TruffleSOM, clustered by micro and macro benchmarks, without (above) and with (below) optimizations', out.width = "0.8\\textwidth", fig.align='center'>>=
...
<<perf-overview-macro, fig.cap='Overhead of TruffleMate normalized to TruffleSOM, clustered by micro and macro benchmarks, without (above) and with (below) optimizations', out.width = "0.8\\textwidth", fig.align='center'>>=
