...
if (Sys.getenv("RSTUDIO") == "1") { 
  setwd("/Users/guidochari/Documents/Projects/MatePerformance/Report") 
...
@
<<Changepoint, child='Warmups/Changepoint.Rnw', results='asis'>>=
@
...
@
<<EphemeralPerformance, child='ReflectiveCompilation/instanceMigration.Rnw', results='asis'>>=
@
<<IndirectPerformance, child='ReflectiveCompilation/indirectVariability.Rnw', results='asis'>>=
@
