...
steady <- getWarmedupData("../../Data/areWeFast.data", c("Value", "Benchmark", "VM", "Suite", "Iteration"), 
                          vmNamesMap(), 
                          c("SOMpe-Ent", "SOMmt", "Java", "Pharo", "Node.js"),
...
<<languages-perf-overview, fig.width=5, fig.height=2, fig.cap='Overhead factor for different language implementations compared to Java.'>>=
...
awfTableData <- summarizedPerBenchAndVM[,c(2,1,7,8,3:6)]
print(
